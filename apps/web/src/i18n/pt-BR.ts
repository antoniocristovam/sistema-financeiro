...
export const ptBR = {
  ...
  cards: {
    ...
    subtitle: 'A compra entra na fatura; o dinheiro sai quando você paga.',
    empty: 'Nenhum cartão de crédito cadastrado.',
    emptyHint: 'Cadastre um cartão em Contas para ver as faturas aqui.',
    cycle: 'Fecha dia {closing} · vence dia {due}',
    used: 'Usado',
    available: 'Disponível',
    noInvoices: 'Nenhuma fatura ainda. A primeira compra cria uma.',
    nothingOpen: 'Nenhuma fatura em aberto.',
    showHistory: 'Ver faturas pagas',
    hideHistory: 'Ocultar faturas pagas',
    noHistory: 'Nenhuma fatura paga nos últimos meses.',
    noItems: 'Fatura sem lançamentos.',
    closesOn: 'fecha {date}',
    dueOn: 'vence {date}',
    payWith: 'Pagar com:',
    payConfirm: 'Pagar esta fatura com {account}? O valor sai da conta agora.',
    newInstallment: 'Compra parcelada',
  ...
  budgets: {
    title: 'Orçamentos',
    subtitle: 'Quanto você pode gastar em cada coisa neste mês.',
    new: 'Novo orçamento',
    empty: 'Nenhum orçamento neste mês.',
    limit: 'Limite do mês',
    of: 'de',
    remaining: 'Restam {value}',
    over: 'Estourou {value}',
    rollover: 'Acumular sobra',
    rolloverHint: 'Acumular a sobra do mês anterior',
    carryOver: 'inclui {value} do mês anterior',
    totalConsumed: 'Consumido',
    unbudgeted: 'Fora de orçamento',
    previousMonth: 'Mês anterior',
    nextMonth: 'Próximo mês',
    copyPrevious: 'Copiar do mês anterior',
    deleteConfirm: 'Excluir este orçamento? Os lançamentos continuam onde estão.',
  },

  goals: {
    title: 'Metas',
    subtitle: 'Nesse ritmo, quando você chega lá.',
    new: 'Nova meta',
    empty: 'Nenhuma meta ainda.',
    name: 'Nome',
    namePlaceholder: 'Viagem, reserva de emergência...',
    target: 'Quanto quero juntar',
    deadline: 'Prazo',
    linkedAccount: 'Conta de reserva',
    noLinkedAccount: 'Sem conta de reserva',
    linkedAccountHint:
      'Com conta de reserva, o aporte move dinheiro de verdade. Sem ela, é apenas um registro de progresso.',
    contribute: 'Aportar',
    fromAccount: 'Sai de qual conta',
    registerOnly: 'Esta meta não tem conta de reserva: nenhum saldo muda.',
    percentDone: '{percent}% do objetivo',
    estimated: 'Previsão: {month}',
    pace: 'ritmo de {value}/mês',
    noPace: 'Sem aportes ainda — não dá para estimar.',
    required: 'Precisa de {value}/mês até {date}',
    deleteConfirm: 'Excluir esta meta? As transferências já feitas continuam no extrato.',
  },

  splits: {
    title: 'Divisão',
    pageTitle: 'Divisões',
    pageSubtitle: 'Quem deve quanto — já compensado.',
    divide: 'Dividir',
    notShared: 'Esta despesa não está dividida.',
    paidBy: 'pagou',
    settled: 'acertado',
    undo: 'Desfazer divisão',
    addPerson: 'Adicionar pessoa',
    participantName: 'Nome',
    mySharePreview: 'Minha parte: {mine} de {total}',
    doesNotClose: 'A soma dá {sum}, e a despesa é {total}.',
    types: { EQUAL: 'Igual', PERCENT: 'Porcentagem', FIXED: 'Valor fixo' },
    toReceive: 'A receber',
    toPay: 'A pagar',
    noBalances: 'Nenhuma conta em aberto.',
    noBalancesHint: 'Divida uma despesa no extrato para começar.',
    pendingCount: '{count} despesa(s) em aberto',
    owesMe: 'me deve {value}',
    iOwe: 'eu devo {value}',
    settle: 'Acertar',
    receiveFrom: 'Receber de {name}',
    payTo: 'Pagar para {name}',
    registerTransaction: 'Registrar lançamento na conta',
    account: 'Conta',
    noTransactionHint: 'Sem lançamento: o acerto fica só no histórico.',
    history: 'Acertos',
  },
